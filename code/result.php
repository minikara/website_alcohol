            ...
            <?php
                if (AtLeastOne ($quantitySave['clothes']['week']) == true ){
                    ...
                    echo 'Imagine that you spend twice less money in alcohol, what could you save ?
                        ...
                        echo '<br />And it is <strong>' . $quantitySave['wordPlan']['week'] . ' return flight </strong> that you could buy for Bali, or the US !';
                        echo '</div>';
                ...
                if (AtLeastOne ($quantitySave['clothes']['month']) == true){
                    ...
                    echo 
                        ...
                        echo '<br />And it is <strong>' . $quantitySave['wordPlan']['month'] . ' return flight </strong> that you could buy for Bali, or the US !';
                        echo '</div>';
                ...
                if (AtLeastOne ($quantitySave['clothes']['year']) == true){
                    echo 
                        ...
                        echo '<br />And it is <strong>' . $quantitySave['wordPlan']['year'] . ' return flight </strong> that you could buy for Bali, or the US !';
                        echo '</div>';
